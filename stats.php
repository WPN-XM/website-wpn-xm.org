...
class HighchartHelper
{
    ...
    {
        return file_get_contents(__DIR__.'/downloads/downloads_serverstacks.json');
    }
}
...
<div class="panel panel-default">
  <div class="panel-body">
    <div id="highchart-container-compare-server-stack-downloads" style="min-width: 300px; height: 500px; max-width: 800px; margin: 0 auto"></div>
  </div>
</div>
