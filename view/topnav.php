<body>
 <!-- "Fork me on Github" Ribbon -->
    ...
    <!-- Top Navigation Bar -->
    <header class="navbar navbar-inverse navbar-fixed-top" id="section-home">
      <div class="container" id="top-nav">
        <!-- Logo -->
        <a class="navbar-brand" href="#" style="width: 104px">
          <img alt="WPN-XM" src="images/logo-transparent.png" width="74" height="59" style="display: none; opacity: 1;" title="WPN-XM Server Stack"/>
        </a>
        <!-- Menu Items -->
        <nav class="collapse navbar-collapse" id="navigation-bar">
